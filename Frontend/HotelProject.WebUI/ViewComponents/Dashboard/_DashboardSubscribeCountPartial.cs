    ...
    public class _DashboardSubscribeCountPartial : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://instagram-profile1.p.rapidapi.com/getprofile/metin_yeni"),
                Headers =
                {
                    { "X-RapidAPI-Key", "cccd59ce95msh5b49ff7e7c0ec47p1222bfjsne7ed51ffc2c4" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://twitter32.p.rapidapi.com/getProfile?username=metin_yeni"),
                Headers =
                {
                    { "X-RapidAPI-Key", "cccd59ce95msh5b49ff7e7c0ec47p1222bfjsne7ed51ffc2c4" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://fresh-linkedin-profile-data.p.rapidapi.com/get-linkedin-profile?linkedin_url=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fmetinyeni%2F"),
                Headers =
                {
                    { "X-RapidAPI-Key", "cccd59ce95msh5b49ff7e7c0ec47p1222bfjsne7ed51ffc2c4" },
